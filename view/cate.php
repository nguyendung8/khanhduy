                            ...
                            <form action="index.php?act=cart" method="post">
                                <div class="product-item ">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title name-product"><?= $item['name'] ?></h5>
                                            <p class="card-text des-product"><?= $item['description'] ?></p>
                                        </div>
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">
                                                ...
                                                <span class="text-danger new"><?= $item['price'] ?></span>
                                            </li>
                                            <li class="list-group-item">Trả Góp 0%</li>
                                        </ul>
                                    </div>
                                    <input type="number" name="soluong" min="1" max="10" value="1" style="font-size:20px; width:45px;">
